...
insert into chart (id,song,artist,release) values ( 1,"Shape of you","Ed Sheeran","06/01/2017" );
insert into chart (id,song,artist,release) values ( 2,"Galway girl","Ed Sheeran","17/03/2017" );
insert into chart (id,song,artist,release) values ( 3,"Symphony","Clean Bandit ft. Zara Larsson","17/03/2017" );
insert into chart (id,song,artist,release) values ( 4,"Humble", "Kendrick Lamar", "07/04/2017" );
insert into chart (id,song,artist,release) values ( 5,"It ain't me", "Kygo & Selena Gomez", "16/02/2017" );
insert into chart (id,song,artist,release) values ( 6,"Something just like this", "Chainsmokers & Coldplay", "22/02/2017" );
insert into chart (id,song,artist,release) values ( 7,"Passionfruit", "Drake", "18/03/2017" );
insert into chart (id,song,artist,release) values ( 8,"Stay", "Zedd & Alessia Cara", "23/02/2017" );
insert into chart (id,song,artist,release) values ( 9,"Solo dance", "Martin Jensen", "04/11/2016" );
insert into chart (id,song,artist,release) values ( 10,"Sign of the times", "Harry Styles", "31/03/2017" );
